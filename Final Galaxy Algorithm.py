...
def histogram1D(image_data, lower_fit = 3300, upper_fit = 3800):
...
def Algorithm(image_data, new_filename, interval = 0.25, Filter_Function = \
    ...
    Magnitude_Errors = np.sqrt((2.000E-02)**2 + (2.5/(Galaxy_Errors*np.log(10))**2))
...
def Analysis(data_file, interval = 0.25):
    ...
    Magnitude_Errors = galaxy_data[1]
    Radii = galaxy_data[2]
